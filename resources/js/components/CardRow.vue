<template>
   <tr @click="handleClick" class="border-b border-gray-300 cursor-pointer mt-4">
        <td class="p-5">
        ...
        <td>
            <span class="flex justify-start items-center gap-x-4">
                <Icon icon="solar:card-2-linear" width="25" />
            <h3>{{ item?.name }}</h3>
            </span>
        </td>
        <td>me</td>
     <td @click.stop="openPopupModal" class="p-2 hover:border text-center hover:bg-red-600  hover:text-white cursor-pointer bg-transparent ">
